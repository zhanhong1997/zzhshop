			...
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/product" method="post"
				...
				<input type="hidden" name="oid" value="${order.oid }">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="inputPassword3" value="${user.username }" name="name;
								placeholder="请输收货人">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="confirmpwd" value="${user.telephone }" name="telephone"
								placeholder="请输入联系方式">
						</div>
					</div>
