	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function findOrderInfoByOid(oid){
				...
				$.post(
					"${pageContext.request.contextPath}/admin?method=findOrderInfo",
					{"oid":oid},
					function(data){
						$("#loading").css("display","none");
						var element = "<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>商品</th><th width='20%'>价格</th><th width='15%'>数量</th><th width='20%'>小计</th></tr>";
