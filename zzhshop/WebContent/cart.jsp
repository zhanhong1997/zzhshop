...
<script type="text/javascript">
	function delProductFromCart(pid) {
		if (confirm("您确定要删除本商品吗？")) {
			location.href = "${pageContext.request.contextPath}/product?method=delProductFromCart&pid="
					+ pid;
		}
	}
</script>
...
<body>
							...
							<c:forEach items="${cart.cartItems }" var="entry">
								<tr class="active">
									...
									<td><a href="javascript:;"
										onclick="delProductFromCart('${entry.value.product.pid}')"
	...
	<c:if test="${empty cart.cartItems }">
		<img alt="" src="${pageContext.request.contextPath }/images/empty.jpg">
